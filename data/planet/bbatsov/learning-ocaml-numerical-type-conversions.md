...
3
4
</pre></td><td class="rouge-code"><pre><span class="n">int_of_float</span> <span class="mi">10</span><span class="o">.</span><span class="mi">5</span><span class="p">;;</span>
...
5
6
</pre></td><td class="rouge-code"><pre><span class="n">int_of_float</span> <span class="mi">5</span><span class="o">.</span><span class="mi">5</span><span class="p">;;</span>
...
that bring together common functions for operating on integers and floats.<sup><a href="https://batsov.com/feeds/OCaml.xml#fn:1" class="footnote" rel="footnote" role="doc-noteref">1</a></sup>
